...
export const BLOCK_TEMPLATES: BlockTemplateMeta[] = [
  ...
  {
    type: "CONTACT_FORM",
    title: "Form liên hệ / Yêu cầu báo giá",
    category: "Bán hàng & Chuyển đổi",
    icon: MessageSquare,
    iconBg: "bg-sky-100/80 border border-sky-200/70",
    iconColor: "text-sky-700",
    description: "Form khách gửi tin nhắn hoặc yêu cầu báo giá, kèm cột cam kết hoặc thông tin liên hệ bên cạnh.",
    example: "VD: Gửi thông tin yêu cầu báo giá...",
  },
  {
    type: "INTRO_STORY",
    title: "Đoạn giới thiệu & câu chuyện thương hiệu",
    category: "Thương hiệu",
    icon: FileText,
    iconBg: "bg-amber-100/80 border border-amber-200/70",
    iconColor: "text-amber-700",
    description: "Đoạn giới thiệu căn giữa với logo, tiêu đề, nội dung, ảnh minh hoạ và nút bấm.",
    example: "VD: Đó cũng là lí do Salt & Light được ra đời...",
  },
];
